...
# simulate a server that's taking connections from the outside and then a load
# balancer that ensures that there are enough servers to serve those connections.


import random
# the following code that defines this Server class.
...
# Define the LoadBalancing class :
